...
if(isset($_POST["submit"]))
{
 ...
 {
 	$sql="select * from admin_login where username='$uname' and password='$psw'	";
 // echo $sql;
...
<input type="text" name="username" placeholder="User Name" value="<?php if(isset($uname)){echo $uname;} ?>"  <?php if(isset($code) && $code == 1){ echo "autofocus"; }  ?> /> <br>
<input type="password" name="password" placeholder="Your Password" <?php if(isset($code) && $code == 4){ echo "autofocus"; }  ?> /> <br>
